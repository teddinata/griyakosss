        ...
        <div class="form-group">
            ...
            <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="about" placeholder="About" value=" {{  $item-> about }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="foods">Local Food</label>
                        <input type="text" class="form-control" name="foods" placeholder="Local Foods" value=" {{  $item-> foods }}">
                    </div>
                    <div class="form-group">
